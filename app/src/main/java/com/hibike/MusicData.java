...
class PrimaryMusicData{
    ...
    static public String getName(File music) throws IOException{
        String name="";
    ...
    static public String getName(String path)throws IOException{
        return getName(new File(path));
    }

    static public String getAuthor(File music) throws IOException{
        String author="";
        FileInputStream f=new FileInputStream(music);
        BufferedInputStream fin=new BufferedInputStream(f);
        byte[] arrayForTags=new byte[3];
    ...
    static public String getAuthor(String path) throws IOException{
        return getAuthor(new File(path));
    }

    static public String getAlbum(File music) throws IOException{
        String album="";
        FileInputStream f=new FileInputStream(music);
        BufferedInputStream fin=new BufferedInputStream(f);
        byte[] arrayForTags=new byte[3];
    ...
    static public String getAlbum(String path) throws IOException{
        return getAlbum(new File(path));
    }

    static public String getImage(File music, Context context) throws IOException{
        String imagePath="";
        FileInputStream f=new FileInputStream(music);
        BufferedInputStream fin=new BufferedInputStream(f);
        byte[] arrayForTags=new byte[3];
        fin.read(arrayForTags);
        String tag=new String(arrayForTags, StandardCharsets.US_ASCII);
        if (!tag.equals("ID3")) return imagePath;
        else {
            boolean hasEnd=false;
            int ver=fin.read();
            fin.skip(6);    //Skipping of uninformative bytes
            ...
            while (!hasEnd){
                ...
                switch (tag){
                    case "APIC":
                        ...
                        for (int count=0;fullFileName.toCharArray()[count]!='.';count++) imagePath+=fullFileName.toCharArray()[count];
                        imagePath+=".";
                        fin.skip(6); size-=6;
                        do{
                            chr=fin.read();
                            size--;
                            if (chr!=0) imagePath+=(char) chr;
                        }while (chr!=0);
                        fin.read(); size--;
    ...
    static public String getImage(String path, Context context) throws IOException{
        return getImage(new File(path), context);
    }
            ...
            if (size>=Math.pow(2,maxStap)){
                ...
                switch(maxStap){
                    ...
                    case 4: case 5: case 6: case 7:
                        array[3]+=Math.pow(2,maxStap);
                        break;
                    case 8: case 9: case 10: case 11:
                    case 12: case 13: case 14: case 15:
                        array[2]+=Math.pow(2,maxStap-8);
                        break;
                    case 16: case 17: case 18: case 19:
                    case 20: case 21: case 22: case 23:
                        array[1]+=Math.pow(2,maxStap-16);
                        break;
                    case 24: case 25: case 26: case 27:
                    case 28: case 29: case 30: case 31:
                        array[0]+=Math.pow(2,maxStap-24);
                        break;
                }}
            maxStap--;
